...
import os
from PIL import Image, ImageTk  # Importing PIL library for the background image
...
class EncryptionApp:
    def __init__(self, master):
        ...
        self.encryption_frame.place(relx=0.5, rely=0.5, anchor=tk.CENTER)
...
class DecryptionApp:
    def __init__(self, master):
        ...
        self.decryption_frame.place(relx=0.5, rely=0.5, anchor=tk.CENTER)
